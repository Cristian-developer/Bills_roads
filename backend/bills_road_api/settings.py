...
MIDDLEWARE = [
    ...
    'places_api.cors_middleware.CustomCorsMiddleware',
]
...
SEND_EMAIL_USER = os.environ['SEND_EMAIL_USER'] if os.environ.get('SEND_EMAIL_USER') else ''
SEND_EMAIL_PASSWORD = os.environ['SEND_EMAIL_PASSWORD'] if os.environ.get('SEND_EMAIL_PASSWORD') else ''
